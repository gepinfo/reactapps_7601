...
const Sefscreen =()=> {
    ...
    setfirstName(logindetails.data.firstname);
 	 	setlastName(logindetails.data.lastname);});
    ...
    <section id="i5oq1" className="gpd-section">
        <div id="ivk7p" className="gpd-container">
            <div id="imf4i" className="gdp-row">
...
{firstName} {lastName}
            ...
            <div id="i2wfh" className="gdp-row">
            ...
            <div id="i71ii" className="gdp-row gpd-grid">
