...
import { Getallusers,uploadImgFile ,Getuser,UpdateUserImg,Updateuser,Getroles} from '../user.service';
import { Upload } from '../../../shared/shared.service';
import { BrowserRouter, Route,Router,NavLink, useLocation, useHistory} from 'react-router-dom';
  ...
  const [rolechange,setRolechange] = useState('')
   ...
   const Userdetails=(id:any)=>{     
    ...
    console.log("userdetails called",id);
     Getuser(id).then((users:any) => {
        console.log("dataof user===>",users);
        defaultRole = users.data.role.role;
        console.log("def",defaultRole);
        const user = users;
       ...
       console.log("email",Userobject.username);
       ...
       Getroles().then(roledata => {
         ...
         let Roles = roledata.data
          ...
          // let Roles = {roles};
         defaultUserRole = Userobject.role;
          console.log('--------',defaultUserRole);  
        var  Default = defaultUserRole;
    ...
    return(
        ...
        <form onSubmit={(e)=>Update(e)}> 
            <div className="row">
                <div className="col-sm-4">
                    <div className="form-group">
                        <Label className="label color"><strong className='color'>First Name</strong></Label>
                        <input value={data} type="text" className="form-control" placeholder="Firstname"  name="firstname"/>
                    </div>
                </div>
                <div className="col-sm-4">
                    <div className="form-group">
                        <Label className="label color"><strong className='color'>Last Name</strong></Label>
                        <input value={datas} type="text" className="form-control" placeholder="Lastname"  name="lastname" />
                    </div>
                </div>
                <div className="col-sm-4">
                    <div className="form-group">
                        <Label className="label color"><strong className='color'>User Name</strong></Label>
                        <input value={Userobject.username} type="text" className="form-control"  placeholder="Username"  name="username"/>
                    </div>
                </div>
            </div>
            ...
            <div className="row">
                <div className="col-sm-4">
                    <div className="form-group">
                        <Label ><strong className='color'>Email</strong></Label>
                        <input value={value} type="email" className="form-control" placeholder="Email" name="email"/>
                    </div>
                </div>
                <div className="col-sm-4">
                    <div className="form-group">
                      
                        <Label className=" color"><strong className='color'>Profile Pic</strong></Label>
                        <input id="exampleFile" name="file" type="file" className="form-control-file" value=""/>
                    </div>
                </div>
            </div>
            <div className="row">
                <div className="col-sm-6">
                    <div className="form-group">
                        <Label className=" color"><strong className='color'>Role</strong></Label>
                        <select className="form-control role" onChange={(e)=>onChange(e)} >
                               {roles.map((key)=>{
                ...
                <div className="col-sm-6">
                    ...
                    <button type="submit" className="btn btn-primary"  onClick={cancle} >cancel</button>
                </div>
            </div>
        </form>
    </div>
